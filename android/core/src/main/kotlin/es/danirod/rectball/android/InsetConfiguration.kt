 ...
 */
class InsetConfiguration(private val view: Activity, private val game: RectballGame) {

    private val strategy: InsetConfigurationStrategy = when {
        // On anything under 19, there are no insets to apply
        Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT -> NoopInsetConfigurationStrategy()

        // Use a very deprecated code to set the insets on Android 4.4
        Build.VERSION.SDK_INT == Build.VERSION_CODES.KITKAT -> LegacyInsetConfigurationStrategy()
